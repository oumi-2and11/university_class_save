...
int main() {
    ...
    const unsigned char key[]="1234567890123456";//{0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39,0x30,0x31,0x32,0x33,0x34,0x35,0x36}; 
    ...
    aesDecrypt(key, 16, ct, plain, 32);//ct[32]是32字节密文，plain[32]存放明文，key是密钥 

    printf("output plain text（明文是）:\n");
    for (i = 0; i < 32; ++i) {
        printf("%c", plain[i]);
    }
